...
for (lag in seq.int(3, 12, 1)) {

  lngth <- frq - lag

  ## lagalize stacks
  dat_lst <- lagalize(x = stck_sst_dsn_dns, y = stck_prcp_kili_dsn_dns,
                      lag = lag, freq = frq)
